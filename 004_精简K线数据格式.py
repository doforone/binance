...
if __name__ == "__main__":
    ...
    for ff in file_names:
        ...
        uuu2=[[int(x[0]/1000), f0(x[1]), f0(x[2]), f0(x[3]), f0(x[4]), f0(x[5]), x[6], f0(x[7]), x[8], f0(x[9]), f0(x[10])] for x in uuu]
            
        with open(f'data2\\{ff}', 'w', encoding='utf-8', newline='\r\n') as f:
            f.write(json.dumps(uuu2, indent=0, ensure_ascii=False))
