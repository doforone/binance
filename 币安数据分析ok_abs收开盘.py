...
if __name__ == "__main__":
    ...
    bb=["BTCUSDT","ETHUSDT","AIONUSDT","ANTUSDT","EOSUSDT","GXSUSDT","HIVEUSDT",\
        "HOTUSDT","LSKUSDT","NMRUSDT","NULSUSDT","OMGUSDT","ONGUSDT","ONTUSDT",\
        "REPUSDT","XRPUSDT"]
    for b in bb:
        limit=1000
        ...
        if t.is_alive ():
            ...
            try:
                ...
                #Image1.show()
                image.save(f"img_收开盘/{b}_{a}_1.png", "png")
            except Exception as e:
                print(e)
                pass
